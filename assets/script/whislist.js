...
addTowhislistButtons.forEach((button, index) => {
  button.addEventListener("click", () => {
    ...
    const productName =
      document.querySelectorAll(".productTitle")[index].textContent;
    const productPrice =
      document.querySelectorAll(".productPrice")[index].textContent;
...
function updateWishlist() {
  ...
  wishlist.forEach((item, index) => {
    ...
    wishlistItem.classList.add("whisDiv","product");
    ...
    wishlistItem.innerHTML = `
      ...
      <div class="content">
        ...
        <small class="price"><b>Price: </b>${item.price}</small>
      </div>
  ...
  wishlistLengthElement.textContent = wishlist.length;
}
